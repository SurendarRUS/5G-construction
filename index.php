...
<div class="row about container-fluid my-3 col-lg-10 col-xl-10 mx-auto">
    <article class="col-xs-11 col-sm-11 col-md-6 col-lg-6 col-xl-6 mx-auto">
    ...
    <aside class="col-xs-11 col-sm-11 col-md-6 col-lg-6 col-xl-6 mx-auto d-flex justify-content-center">
        <img class="mx-auto" src="https://images.pexels.com/photos/38293/workers-construction-site-hardhats-38293.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="">
       
    </aside>
    
</div>
<?php include ('php/header.php');?>
<?php include ('php/queryForm.php')?>
<?php include ('php/carousel.php');?>
<?php include ('php/about.php');?>
<?php include ('php/services.php');?>
<?php include ('php/footer.php');?>
>>>>>>> 808a15e70c973ab14c62fe460e117ae6d871473f
